...
namespace ABPEasyWebCreation.Web.Startup
{
    ...
    /// </summary>
    public class ABPEasyWebCreationNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                .AddItem(
                    ...
                    new MenuItemDefinition(
                        PageNames.Employees,
                        L(PageNames.Employees),
                        url: PageNames.Employees,
                        icon: "people",
                        requiredPermissionName: PermissionNames.Pages_Employee_List
                    )
                )
                .AddItem(
                    new MenuItemDefinition(
