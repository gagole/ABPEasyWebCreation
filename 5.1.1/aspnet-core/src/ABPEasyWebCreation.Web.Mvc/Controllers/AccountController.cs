...
using ABPEasyWebCreation.Sessions;
using ABPEasyWebCreation.Web.Models.Account;
using ABPEasyWebCreation.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNet.Identity;

namespace ABPEasyWebCreation.Web.Controllers
{
    public class AccountController : ABPEasyWebCreationControllerBase
    {
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            try
            {
                ...
                user.Password = new PasswordHasher().HashPassword("123@Abc");
